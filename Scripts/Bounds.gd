...
"""
	This class is responsable of boundaries limit of the snake.
	If the snake quit the screen, let it appear in the another side. (mirror)
"""
...
func wrap_vector(v: Vector2) -> Vector2:
	""""
		If the head quit the screen, let it appear in the another screen side
	"""
	if v.x > x_max:
